...
<header>
    <div class="logo">
        <h1 class="logo-txt"><a href="<?php echo BASE_URL; ?>/index.php"><i class="fas fa-book-reader"></i>The Blog</a></h1>
    </div>
    <i class="fa fa-bars menu-switch" onclick="toggleMenu('.nav')"></i>
    <ul class="nav">
        <li><a href="<?php echo BASE_URL; ?>/index.php">Accueil</a></li>
        <li><a href="<?php echo BASE_URL; ?>/vue/phpfiles/Resources/apropos.php">À Propos</a></li>
